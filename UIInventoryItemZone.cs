...
public abstract class UIInventoryItemZone : MonoBehaviour
{
	...
	public static AccessLevel GetCurrentAccessLevel()
	{
		...
		if (RestZone.PartyInRestZone || UIInventoryManager.Instance.StashAccess || GameState.Instance.CurrentMap == null || GameState.Instance.CurrentMap.GetCanAccessStash() || GameState.Option.GetOption(GameOption.BoolOption.DONT_RESTRICT_STASH))
		{
