...
public class UIDrawCall : MonoBehaviour
{
	...
	private int mShaderPixelSnapProp;
	...
	private void Awake()
	{
		mShaderPixelSnapProp = Shader.PropertyToID("_PixelSnap");
	}
	...
	private void UpdateMaterials()
	{
		if (mClipping != 0)
		{
			...
			if (shader != null)
			{
				...
				mClippedMat.SetFloat(mShaderPixelSnapProp, mPixelSnap ? 1f : 0f);
			}
		...
		Material material = ((mClippedMat != null) ? mClippedMat : mSharedMat);
		if (mDepthMat != null)
		{
