...
public class UIDragObject : IgnoreTimeScale
{
	...
	{
		mPanel = ((target != null) ? UIPanel.Find(target.transform, createIfMissing: false) : null);
		if (mPanel == null)
		{
	...
	private void OnPress(bool pressed)
	{
		...
		if (pressed)
		{
			...
			mPlane = new Plane(((mPanel != null) ? mPanel.cachedTransform.rotation : transform.rotation) * Vector3.back, mLastPos);
		}
